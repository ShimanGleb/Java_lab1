...
public class Date {
	...
	public void SplitDate()
	{
		...
		hour+=(Integer.valueOf(initialIndex+13)-48)*10;
		hour+=Integer.valueOf(initialIndex+14)-48;
		minute+=(Integer.valueOf(initialIndex+16)-48)*10;
		minute+=Integer.valueOf(initialIndex+17)-48;
		second+=(Integer.valueOf(initialIndex+19)-48)*10;
		second+=Integer.valueOf(initialIndex+20)-48;
	}
}
